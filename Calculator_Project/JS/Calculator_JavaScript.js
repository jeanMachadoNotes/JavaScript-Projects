...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        // otherqwise it adds onto it.
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit; //Iternary Operator, adds digit pushed to calculator display
    }
}
